...
export default function AuthenticateWithGithubButton (props: IAuthenticationButtonProps): JSX.Element {
  ...
  return (
      <button aria-label="Continue with github" onClick={(event) => {
        void handleLoginOrSignupWithGithub(event)
              ...
              className="focus:outline-none hover:text-zinc-600 focus:ring-2 focus:ring-offset-1 focus:ring-zinc-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
