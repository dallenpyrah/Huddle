        ...
        <div className="col-span-3">
            ...
            <div className="grid grid-cols-2 gap-4 ml-5 h-80">
                {isStateLoaded && newGroups.length > 0 && newGroups.map((group, index) => (
                    <div key={index}
                         className={`${index === 2 && newGroups.length === 3 ? 'col-span-2' : 'col-span-1'} ${findValidColor(group)} rounded-md p-3 text-white cursor-pointer flex justify-center items-center hover:-translate-y-1.5`}>
