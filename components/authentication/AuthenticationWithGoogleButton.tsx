...
export default function AuthenticateWithGoogleButton (props: { passErrorMessage: (errorMessage: string) => void }): JSX.Element {
  ...
  return (
        <button aria-label="Continue with google" onClick={(event) => {
          void handleLoginOrSignupWithGoogle(event)
        }} role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full">
