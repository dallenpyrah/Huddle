...
export default function SideBarListItem (props: { title: string, icon?: IconProp, navigateTo: string }): JSX.Element {
  return (
        <li>
            <a href={props.navigateTo} className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:text-white dark:text-white hover:bg-slate-100 dark:hover:bg-gray-700">
